...
parser = argparse.ArgumentParser("random_search")
parser.add_argument('--n_steps', type=int, default=3, help='total number of layers in one cell')
parser.add_argument('--n_classes', type=int, default=6, help='total number of classes')
parser.add_argument('--init_channels', type=int, default=32, help='num of init channels')
parser.add_argument('--in_channels', type=int, default=41, help='num of init channels')
